...
public class MainActivity extends Activity {
    ...
    private View buildForceUpdateView(String url) {
        LinearLayout root = new LinearLayout(this);
        root.setOrientation(LinearLayout.VERTICAL);
        root.setGravity(Gravity.CENTER);
        root.setPadding(dp(24), dp(24), dp(24), dp(24));
    ...
    private void startUpiPayment(String planName, double amount, int durationDays) {
    ...
    private View buildPlanCard(String name, String price, String desc, double amount, int durationDays) {
        LinearLayout card = new LinearLayout(this);
        card.setOrientation(LinearLayout.VERTICAL);
